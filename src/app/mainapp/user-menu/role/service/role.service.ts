...
export class RoleService {
  ...
  getRoles(params = "") {
    return this.api.getAPI<ResponseSuccess<RoleOnly>>(this.baseUrl2+params);
  }
  ...
  createRoleDetail(data: CreateRoleDto){
    return this.api.postAPI<ResponseSuccess<Role>>(this.baseUrl+'new', data);
  }

  updateRole(id: number, data: CreateRoleDto){
    return this.api.patchAPI<ResponseSuccess<Role>>(this.baseUrl+id, data);
  }

  updateRoleDetail(id: number, data: CreateRoleDto){
    return this.api.patchAPI<ResponseSuccess<Role>>(this.baseUrl+'update/'+id, data);
  }
